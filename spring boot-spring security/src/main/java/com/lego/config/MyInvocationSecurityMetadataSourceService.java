...
/**
 * FilterInvocationSecurityMetadataSource 的作用是用来储存请求(url)与权限的对应关系
 */
@Component
public class MyInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
    ...
    /**
     * 返回请求的资源需要的角色
     * 当接收到一个http请求时, filterSecurityInterceptor会调用的方法. 参数object是一个包含url信息的HttpServletRequest实例.
     * 这个方法要返回请求该url所需要的所有权限集合（permission表中指定的）
     */
    @Override
    ...
    /**
     * 初始化 数据库permission表中的所有资源(url) 对应的角色(role)
     */
